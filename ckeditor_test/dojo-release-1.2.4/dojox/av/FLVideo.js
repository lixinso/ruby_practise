...
var _2={path:this._swfPath.uri,width:"100%",height:"100%",params:{allowFullScreen:true,wmode:"transparent"},vars:{videoUrl:this.mediaUrl,id:this.id,autoPlay:this.autoPlay,volume:this.initialVolume,isDebug:this.isDebug}};
...
},_normalizeUrl:function(_c){
if(_c&&_c.toLowerCase().indexOf("http")<0){
...
return _e;
},_sub:function(_f,_10){
dojo.subscribe(this.id+"/"+_f,this,_10);
},destroy:function(){
if(!this.flashMedia){
